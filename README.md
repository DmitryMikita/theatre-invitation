...
Кнопка аплодисментов открывает бархатный занавес. За ним — билет с приглашением на свидание. Нажатие на билет переворачивает его; до получения настоящего QR на обороте показана надпись «Билет скоро появится».
...
Сейчас QR не имитируется и входным билетом не является. Реальное изображение выводится без обрезки на белом фоне.
